                          ...
                          <ul class="chat">
                            <li class="left clearfix">
                              <span class="chat-img pull-left">
                                <img src="<?php echo base_url()?>assets/images/profile/profile2.jpg" alt="User Avatar">
                              </span>
                            ...
                            <li class="right clearfix">
                              <span class="chat-img pull-right">
                                <img src="<?php echo base_url()?>assets/images/profile/profile3.jpg" alt="User Avatar">
                              </span>
                              <div class="chat-body clearfix">
                              <div class="header">
